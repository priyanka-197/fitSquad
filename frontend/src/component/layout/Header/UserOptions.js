...
import ShoppingCarytIcon from "@material-ui/icons/ShoppingCart"
...
const UserOptions = ({user}) => {
    ...
    {icon:<ShoppingCarytIcon style={{color:cartItems.length>0?"tomato":"unset"}}/>,name:`Cart(${cartItems.length})`,func:cart},
